# Angular-Trigger-PageHit — the seed for AngularJS apps
...
Application is in working state and is [deployed]()
- - -
...
app/                    --> all of the source files for the application
  ...
  aboutYou/                --> the aboutYou view template and logic
    aboutYou.html            --> the partial template
    aboutYou.js              --> the controller logic
    aboutYou_test.js         --> tests of the controller
  vehicles/                --> the vehicles view template and logic
    vehicles.html            --> the partial template
    vehicles.js              --> the controller logic
    vehicles_test.js         --> tests of the controller
  driverDetails/                --> the driverDetails view template and logic
    driverDetails.html            --> the partial template
    driverDetails.js              --> the controller logic
    driverDetails.js         --> tests of the controller
